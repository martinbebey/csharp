...
public class DBAccess
{
    ...
    public void RetrieveData(string selectQuery, int transNum, TheLog theLog, OracleConnection connection)
    {
        ...
        try
        {
            ...
            {
                OracleDataReader rdr = cmd.ExecuteReader();//the db reader
    ...
    public void ChangeData(string iduQuery, string queryType, int transNum, TheLog theLog, OracleConnection connection)
    {
