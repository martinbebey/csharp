...
namespace CSKicksCollection.Trees
{
        ...
        where T : IComparable
    {
        ...
        /// <summary>
        /// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// Traverses and displays the tree inorder  //taken from www.worldbestlearningcenter.com/index_files/csharp-oop-binary-tree-printing.htm
        /// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// </summary>
        public void PrintTreeInOrder(BinaryTreeNode<T> tree)
        {
            if (tree != null)
            {
        ...
        /// <summary>
        /// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// Traverses and displays the tree preorder  //taken from www.worldbestlearningcenter.com/index_files/csharp-oop-binary-tree-printing.htm
        /// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// </summary>
        public void PrintTreePreOrder(BinaryTreeNode<T> tree)
        {
            if (tree != null)
            {
                Console.WriteLine(tree.Value);
        ...
        /// <summary>
        /// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// Displays only the root  //taken from www.worldbestlearningcenter.com/index_files/csharp-oop-binary-tree-printing.htm
        /// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// </summary>
        public void PrintTreeRootOnly(BinaryTreeNode<T> tree)
        {
            if (tree != null)
            {

                Console.WriteLine("{0} was found.", tree.Value);
        ...
        /// <summary>
        /// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// Finds spells and counts number of nodes visited on each search
        /// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// </summary>
        public virtual BinaryTreeNode<T> Find(T value, ref int count)
        {
            BinaryTreeNode<T> node = this.head; //start at head
            while (node != null)
            {
