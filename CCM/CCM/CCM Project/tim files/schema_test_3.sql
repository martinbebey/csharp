...
INSERT INTO `ccm_test`.`Employee` (`id`, `name`, `email`, `pw`) VALUES (0000000, 'Mar\'n', 'mm@test.com', 'aaa');
INSERT INTO `ccm_test`.`Employee` (`id`, `name`, `email`, `pw`) VALUES (1111111, 'Bim', 'lilt@test.com', 'bbb');
INSERT INTO `ccm_test`.`Employee` (`id`, `name`, `email`, `pw`) VALUES (2222222, 'Stephan', 'bigs@test.com', 'ccc');
